...
public class TargetMover: MonoBehaviour {
    ...
    [SerializeField] SlowTiles slowTiles = null;
    ...
    private HexTilemapGraph tilemapGraph = null;
    private float timeBetweenSteps;

    protected virtual void Start() {
        tilemapGraph = new HexTilemapGraph(tilemap, allowedTiles.Get(), slowTiles.Get());
    ...
    private void MakeOneStepTowardsTheTarget() {
        ...
        endNode = new Vector3Int(endNode.x, endNode.y, 0);
        List<Vector3Int> shortestPath = AStar.GetPath(tilemapGraph, startNode, endNode, tilemapGraph.Distance, tilemapGraph.Heuristic, maxIterations);
